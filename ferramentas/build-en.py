...
('Especialista de Tesouraria na Kinross Gold. Caixa, hedge cambial e capital de giro para Brasil e Chile. Automa&#231;&#227;o, dados e agentes de IA constru&#237;dos de dentro do problema.'.replace('&#231;','ç').replace('&#227;','ã').replace('&#237;','í'),
 'Treasury Specialist at Kinross Gold. Cash, FX hedging and working capital for Brazil and Chile. Automation, data and AI agents built from inside the problem.', 2),
...
('content="Pedro Maia, Especialista de Tesouraria na Kinross Gold. Ao fundo, uma poca de ouro derretido no piso de uma camara de aco."',
 'content="Pedro Maia, Treasury Specialist at Kinross Gold. Behind him, a pool of molten gold in the floor of a steel chamber."', 1),
...
('<p class="kicker">O ESCOPO</p>', '<p class="kicker">THE SCOPE</p>', 1),
('<p class="line">Brasil e Chile. Caixa, hedge cambial, capital de giro.</p>',
 '<p class="line">Brazil and Chile. Cash, FX hedging, working capital.</p>', 1),
...
('<p class="role">Especialista de Tesouraria na <b>Kinross Gold</b></p>',
 '<p class="role">Treasury Specialist at <b>Kinross Gold</b></p>', 1),
...
('<p>Especialista de Tesouraria na Kinross Gold. Caixa, hedge cambial e capital de giro para Brasil e Chile. Uma década em finanças, agora com dados e agentes de IA em cima.</p>',
 '<p>Treasury Specialist at Kinross Gold. Cash, FX hedging and working capital for Brazil and Chile. A decade in finance, now with data and AI agents on top.</p>', 1),
...
('alt="Escada de aço soldada subindo a parede de uma câmara, com um brilho quente no pé dela."',
 'alt="A welded steel ladder climbing the wall of a chamber, with a warm glow at its foot."', 1),
...
('alt="Bancada de aço maciço no centro de uma câmara fria, com um reflexo quente atravessando o tampo."',
 'alt="A solid steel workbench in the middle of a cold chamber, with a warm reflection across the top."', 1),
('<dt>OPERAÇÃO</dt><dd>Mineração de ouro, uma das maiores do Brasil</dd>',
 '<dt>OPERATION</dt><dd>Gold mining, one of the largest in Brazil</dd>', 1),
...
('<dt>INSTRUMENTOS</dt><dd>Câmbio, derivativo de hedge, dívida, capital de giro, garantias</dd>',
 '<dt>INSTRUMENTS</dt><dd>FX, hedging derivatives, debt, working capital, guarantees</dd>', 1),
('<dt>ÓRGÃOS E SISTEMAS</dt><dd>Banco Central do Brasil, BM&amp;F, SELIC, CETIP</dd>',
 '<dt>BODIES AND SYSTEMS</dt><dd>Central Bank of Brazil, BM&amp;F, SELIC, CETIP</dd>', 1),
('<dt>CICLO</dt><dd>Diário, semanal, mensal, trimestral</dd>',
 '<dt>CYCLE</dt><dd>Daily, weekly, monthly, quarterly</dd>', 1),
...
('alt="Conduíte de aço segmentado por flanges parafusados, recuando ao longo da parede."',
 'alt="A steel conduit segmented by bolted flanges, receding along the wall."', 1),
...
('>Segure para rodar um ciclo<', '>Hold to run a cycle<', 1),
...
('alt="Molde retangular embutido no piso de aço, com metal ainda incandescente dentro."',
 'alt="A rectangular mould set into a steel floor, with metal still glowing inside."', 1),
